        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                ...
                '<div class="action-buttons">
                    @can("user.update")
                        <button title="Edit" type="button" data-href="{{action(\'SalesCommissionAgentController@edit\', [$id])}}" data-container=".commission_agent_modal" class="btn-modal">
                            <img src="' . asset('img/icons/edit.svg') . '" alt="">
                        </button>
                    @endcan
                    @can("user.delete")
                        <button title="Delete" data-href="{{action(\'SalesCommissionAgentController@destroy\', [$id])}}" class="delete_commsn_agnt_button">

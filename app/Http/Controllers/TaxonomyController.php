        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                'action', function ($row) use ($can_edit, $can_delete, $category_type) {
                    ...
                    if ($can_edit) {
                        $html .= '<button data-toggle="tooltip" data-placement="top" title="Edit" data-href="' . action('TaxonomyController@edit', [$row->id]) . '?type=' . $category_type . '" class="edit_category_button">
                                    <img src="' . asset('img/icons/edit.svg') . '" alt="">
                                </button>';
                    }
            
                    if ($can_delete) {
                        $html .= '<button data-toggle="tooltip" data-placement="top" title="Delete" data-href="' . action('TaxonomyController@destroy', [$row->id]) . '" class="delete_category_button">

...
class StockAdjustmentController extends Controller
{
    ...
    {
        if (!auth()->user()->can('adjustment.view') && !auth()->user()->can('adjustment.create')) {
    ...
    '<div class="action-buttons">
        <button type="button" title="@lang("messages.view")" data-href="{{ action("StockAdjustmentController@show", [$id]) }}" class="btn-modal" data-container=".view_modal">
            <img src="' . asset('img/icons/eye.svg') . '" alt="">
        </button>
        <button type="button" title="@lang("messages.delete")" data-href="{{ action("StockAdjustmentController@destroy", [$id]) }}" class="delete_stock_adjustment ' . $hide . '">

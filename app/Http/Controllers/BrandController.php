        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                ...
                '<div class="action-buttons">
                     @can("brand.update")
                         <button title="@lang("messages.edit")" data-toggle="tooltip" data-placement="top" data-href="{{action(\'BrandController@edit\', [$id])}}" class="edit_brand_button">
                             <img src="' . asset('img/icons/edit.svg') . '" alt="">
                         </button>
                     @endcan
                     @can("brand.delete")
                         <button title="@lang("messages.delete")" data-toggle="tooltip" data-placement="top" data-href="{{action(\'BrandController@destroy\', [$id])}}" class="delete_brand_button">

        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                ...
                '<div class="action-buttons">
                     <a href="{{action(\'BarcodeController@edit\', [$id])}}" title="@lang("messages.edit")">
                         <img src="' . asset('img/icons/edit.svg') . '" alt="">
                     </a>
                     <button title="@lang("messages.delete")" type="button" data-href="{{action(\'BarcodeController@destroy\', [$id])}}" class="delete_barcode_button" @if($is_default) disabled @endif>
                     ...
                     @else
                         <button class="btn btn-xs btn-info set_default" data-href="{{action(\'BarcodeController@setDefault\', [$id])}}">

            ...
            return Datatables::of($printer)
                ...
                ->addColumn(
                    ...
                    '<div class="action-buttons">
                        @can("printer.update")
                            <a title="@lang("messages.edit")" href="{{action(\'PrinterController@edit\', [$id])}}">
                                <img src="' . asset('img/icons/edit.svg') . '" alt="">
                            </a>
                            &nbsp;
                        @endcan
                        @can("printer.delete")
                            <button title="@lang("messages.delete")" data-href="{{action(\'PrinterController@destroy\', [$id])}}" class="delete_printer_button">

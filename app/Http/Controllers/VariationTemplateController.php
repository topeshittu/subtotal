        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                ...
                '<div class="action-buttons">
                    <button data-toggle="tooltip" data-placement="top" title="@lang("messages.edit")" data-href="{{action(\'VariationTemplateController@edit\', [$id])}}" class="edit_variation_button">
                        <img src="' . asset('img/icons/edit.svg') . '" alt="">
                    </button>
                    &nbsp;
                    @if(empty($total_pv))
                        <button data-toggle="tooltip" data-placement="top" title="@lang("messages.delete")" data-href="{{action(\'VariationTemplateController@destroy\', [$id])}}" class="delete_variation_button">

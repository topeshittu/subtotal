...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if (!empty(request()->start_date) && !empty(request()->end_date)) {
                ...
                $purchases->where('transactions.trans_date', '>=', $start)
    ...
    {
        $is_purchase = request()->get('status');
        ...
        return view('purchase.partials.filter')
               ->with(compact('business_locations', 'suppliers', 'orderStatuses', 'is_purchase', 'shipping_statuses'));
    }
}

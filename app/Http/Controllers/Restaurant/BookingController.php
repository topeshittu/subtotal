...
class BookingController extends Controller
{
    ...
    public function __construct(Util $commonUtil, RestaurantUtil $restUtil, ModuleUtil $moduleUtil)
    {
    ...
    public function index()
    {
        ...
        return view('restaurant.booking.index', compact('business_locations', 'customers', 'correspondents', 'types', 'customer_groups', 'is_zatca'));
    }

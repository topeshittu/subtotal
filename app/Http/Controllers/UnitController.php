            ...
            ->addColumn(
                ...
                '@can("unit.update")
                    <div class="action-buttons">
                        <button title="@lang("messages.edit")" type="button" data-href="{{action(\'UnitController@edit\', [$id])}}" class="btn-modal edit_unit_button" data-toggle="tooltip" data-placement="top" title="Edit">
                    ...
                    @can("unit.delete")
                        <button title="@lang("messages.delete")" data-href="{{action(\'UnitController@destroy\', [$id])}}" class="delete_unit_button" data-toggle="tooltip" data-placement="top" title="Delete">

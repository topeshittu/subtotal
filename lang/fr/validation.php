...
return [
    ...
    | que les règles de taille. N \'hésitez pas à modifier chaque message ici.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer notre emplacement d \'attribut
    ...
    */
    ...
    'attributes' => [],
    'custom-messages' => [
        'quantity_not_available' => 'Il n \'y a que :qty :unit disponible',

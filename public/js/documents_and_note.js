            ...
            init: function() {
                ...
                this.on("success", function(file, response) {
                    if (response.success && response.file_name) {
                        ...
                        $('input#docus_notes_media').val(file_names.join(','));
                    } else {
                        toastr.error(response.msg || 'File upload failed: ' + file.name);
                        this.removeFile(file);
                    }
                });
                ...
                this.on("removedfile", function(file) {
                    var file_name = file.upload && file.upload.filename ? file.upload.filename : file.name;
                    var existing_value = $('#docus_notes_media').val();
                    var new_value = existing_value.replace(file_name + ",", "");
                    $('#docus_notes_media').val(new_value);
                });
            }

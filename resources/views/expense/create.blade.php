  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
              <p>@lang('lang_v1.is_refund')? @show_tooltip(__('lang_v1.is_refund_help'))</p>
              <div class="toggle-wrapper d-flex gap-2 mt-4">
                  <label class="switch" for="is_refund">
                      {!! Form::checkbox('is_refund', 1, false, ['id' => 'is_refund']) !!}

...
<div class="main-container no-print">
    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            <div class="title">
                <h1>@lang('expense.import_expense')</h1>
                <p>@lang('lang_v1.list_expenses')</p>
            </div>
            <div class="filter">
            <a href="{{ asset('files/import_expense_csv_template.csv') }}" class="add-user-modal-btn btn-block btn bg-yellow" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
            ...
            @component('components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\App\Http\Controllers\ExpenseController::class, 'storeExpenseImport']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                        <br>
                            <button type="submit" class="add-user-modal-btn btn-block btn-primary">@lang('messages.submit')</button>
                        </div>
                        </div>
                    </div>
                {!! Form::close() !!}

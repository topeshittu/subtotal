...
<div class="main-container no-print">
    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            <div class="title">
                <h1>@lang( 'account.balance_sheet')</h1>
                <p>@lang('account.manage_your_account')</p>
            </div>

            <div class="filter">
                <div class="newuser">
                {!! Form::select('bal_sheet_location_id', $business_locations, null, ['class' => 'form-control select2', 'id' => 'bal_sheet_location_id', 'style' => 'width:100%']); !!}
                </div>
                <div class="newuser">
        ...
        <div class="box-body" style="min-height: .01%; overflow-x: auto;">
            <table class="max-table">
                ...
                <tfoot>
                    <tr style="">
                        <td>
                            <table class="max-table mb-0 no-border">
                                <tr>
                                    <th>

                ...
                @foreach($payment_types as $key => $value)
                  <tr>
                    ...
                    <td class="text-center">
                      <label class="switch" for="default_payment_accounts_{{ $key }}_is_enabled">
                          {!! Form::checkbox('default_payment_accounts['.$key.'][is_enabled]', 1, !empty($default_payment_accounts[$key]['is_enabled']), ['id'=>'default_payment_accounts_'.$key.'_is_enabled']) !!}

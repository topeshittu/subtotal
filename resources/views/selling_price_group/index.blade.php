...
<div class="main-container no-print">
    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div class="filter">
                <div class="new-user">
                    <a href="{{action('SellingPriceGroupController@export')}}" class="btn btn-primary" style="width: 100%;">@lang('lang_v1.export_selling_price_group_prices')</a>
                    </div>
                    <div class="new-user">
                    <button type="button" class="btn btn-primary btn-modal" data-href="{{action('SellingPriceGroupController@create')}}" data-container=".view_modal"><i class="fa fa-plus"></i> @lang( 'messages.add' )</button>
                    </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped max-header" id="selling_price_group_table">
                    <thead>
                        <tr>

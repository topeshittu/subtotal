...
<div class="main-container no-print">
    ...
    @include('layouts.partials.sub_menu.report', ['link_class' => 'sub-menu-item'])
</div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th>
                                    @lang('lang_v1.total_manufactured')
                                    </th>
                                    <th>
                                    
                                    @lang('lang_v1.total_used_for_production')
                                    </th>
                                    <th>
                                    @lang('lang_v1.correct_stock')
                                
                                        <small>({{ __('lang_v1.total_stock_calculated') }})</small>
                                    </th>
                                    <th>
                                    @lang('lang_v1.incorrect_stock')

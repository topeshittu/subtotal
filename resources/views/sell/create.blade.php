					...
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							<div class="input-group">
								...
								<!-- Hidden mirrors for packing charge (modal is appended to body; keep form fields here) -->
								<input type="hidden" name="packing_charge" id="packing_charge_hidden" value="0">
								<input type="hidden" name="packing_charge_type" id="packing_charge_type_hidden" value="fixed">
				...
				<div class="row">
					...
					<div class="row col-sm-12 pos_product_div" style="min-height: 0">
						...
						<div class="table-responsive" style="min-height: .01%; max-height:600px; overflow-x: auto; overflow-y:auto">
								...
								<tbody class="invoice-tbody"></tbody>
							</table>
						</div>

				...
				<div class="accordionItem">
					...
					<div class="accordionContent">
						<div class="row">
							...
							<!-- Hidden inputs to capture packing charge from Types of Service modal -->
							{!! Form::hidden('packing_charge', $transaction->packing_charge ?? 0, ['id' => 'packing_charge_hidden']) !!}
							{!! Form::hidden('packing_charge_type', $transaction->packing_charge_type ?? 'fixed', ['id' => 'packing_charge_type_hidden']) !!}
							@endif

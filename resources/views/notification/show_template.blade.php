              ...
              <div id="email_collapse" class="panel-collapse collapse in" aria-expanded="true">
                <div class="box-body">
                    <<div class="form-group @if($notification_template['template_for'] == 'send_ledger') hide @endif">
                      <p>@lang('lang_v1.send_email')</p>
                      <div class="toggle-wrapper d-flex gap-2 mt-4">
                          <label class="switch" for="notification_type_email">
                              {!! Form::checkbox('notification_type[]', 'email', true, ['id' => 'notification_type_email', 'class' => 'notification_type']) !!}
                  ...
                  <div id="sms_collapse" class="panel-collapse collapse" aria-expanded="false">
                    <div class="box-body">
                        <div class="form-group @if($notification_template['template_for'] == 'send_ledger') hide @endif">
                            ...
                            {!! Form::text('mobile_number', $contact->mobile, ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.mobile_number')]); !!}
                            </div>

        ...
        {!! Form::label('packing_charge', __( 'lang_v1.packing_charge' ) . ':') !!}
          ...
          <div class="col-sm-12">
            <div class="form-group">
                <p>@lang('lang_v1.enable_custom_fields') @show_tooltip(__('lang_v1.types_of_service_custom_field_help'))</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="enable_custom_fields">
                        {!! Form::checkbox('enable_custom_fields', 1, !empty($type_of_service->enable_custom_fields), ['id' => 'enable_custom_fields']) !!}

  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
              <p><strong>@lang('lang_v1.applicable_in_cg')</strong></p>
              <div class="toggle-wrapper d-flex gap-2 mt-4">
                  <label class="switch" for="applicable_in_cg">
                      {!! Form::checkbox('applicable_in_cg', 1, !empty($discount->applicable_in_cg), ['id' => 'applicable_in_cg']) !!}
      ...
      <div class="col-sm-6">
          <div class="form-group">
              <p><strong>@lang('lang_v1.is_active')</strong></p>
              <div class="toggle-wrapper d-flex gap-2 mt-4">
                  <label class="switch" for="is_active">
                      {!! Form::checkbox('is_active', 1, !empty($discount->is_active), ['id' => 'is_active']) !!}
                      <div class="sliderCheckbox round"></div>
                  </label>
              </div>
          </div>

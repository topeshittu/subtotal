    ...
    @endphp
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[adjustment_view]', 'adjustment.view', in_array('adjustment.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.view_all_stock_adjustment' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[adjustment_view]', 'view_own_purchase', in_array('view_own_adjustment', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.view_own_stock_adjustment') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'adjustment.create', in_array('adjustment.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.adjustment.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'adjustment.update', in_array('adjustment.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.adjustment.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.adjustment.delete' ) }}
              </label>
            </div>
          </div>
        </div>
      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase_sell_mismatch.view',  in_array('purchase_sell_mismatch.view', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.purchase_sell_mismatch' ) }}
              </label>
            </div>
          </div> 
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase_sell_mismatch.fix',  in_array('purchase_sell_mismatch.fix', $role_permissions), [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.remap_purchase_sell' ) }}
              </label>
            </div>
          </div> 
        </div>

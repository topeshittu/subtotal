    ...
    @endphp
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[adjustment_view]', 'adjustment.view', false, 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::radio('radio_option[adjustment_view]', 'view_own_adjustment', false,['class' => 'input-icheck']); !!}
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'adjustment.create', false, 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'adjustment.update', false, 
      ...
      <div class="col-md-9">
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase_sell_mismatch.view', false, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.purchase_sell_mismatch' ) }}
              </label>
            </div>
          </div> 
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'purchase_sell_mismatch.fix', false, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.remap_purchase_sell' ) }}
              </label>
            </div>
          </div> 

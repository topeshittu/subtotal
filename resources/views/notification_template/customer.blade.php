    ...
    <div class="setting-card-wrapper">
        <div class="overview-filter">
            <div class="title">
                ...
                <p>@lang('lang_v1.customer_notifications')</p>
            </div>
    ...
    $('textarea.ckeditor').each( function(){
     ...
     $(document).ready( function() {
        ...
        $('#page').on('change', function() {
            ...
            if ( target == 'cn_new_sale') {
                 $('#ccn_new_sale').show();
                 $('#ccn_payment_received').hide();
                 $('#ccn_payment_reminder').hide();
                 $('#ccn_new_booking').hide();
                 $('#ccn_new_quotation').hide();
             } else if (target == 'cn_payment_received') {
                $('#ccn_new_sale').hide();
                $('#ccn_payment_received').show();
                $('#ccn_payment_reminder').hide();
                $('#ccn_new_booking').hide();
                $('#ccn_new_quotation').hide();
             } else if (target == 'cn_payment_reminder') {
                $('#ccn_new_sale').hide();
                $('#ccn_payment_received').hide();
                $('#ccn_payment_reminder').show();
                $('#ccn_new_booking').hide();
                $('#ccn_new_quotation').hide();
             } else if (target == 'cn_new_booking') {
                $('#ccn_new_sale').hide();
                $('#ccn_payment_received').hide();
                $('#ccn_payment_reminder').hide();
                $('#ccn_new_booking').show();
                $('#ccn_new_quotation').hide();
             } else if (target == 'cn_new_quotation') {
                $('#ccn_new_sale').hide();
                $('#ccn_payment_received').hide();
                $('#ccn_payment_reminder').hide();
                $('#ccn_new_booking').hide();
                $('#ccn_new_quotation').show();
             } else {
                $('#ccn_new_sale').show();
             }
         });

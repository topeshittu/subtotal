                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                                        <label class="switch" for="template_data_{{ $key }}_auto_send">
                                            {!! Form::checkbox("template_data[$key][auto_send]", 1, $value['auto_send'], ['id' => "template_data_{$key}_auto_send"]) !!}
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                                        <label class="switch" for="template_data_{{ $key }}_auto_send_sms">
                                            {!! Form::checkbox("template_data[$key][auto_send_sms]", 1, $value['auto_send_sms'], ['id' => "template_data_{$key}_auto_send_sms"]) !!}
                                            <div class="sliderCheckbox round"></div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                                        <label class="switch" for="template_data_{{ $key }}_auto_send_wa_notif">
                                            {!! Form::checkbox("template_data[$key][auto_send_wa_notif]", 1, $value['auto_send_wa_notif'], ['id' => "template_data_{$key}_auto_send_wa_notif"]) !!}
                                            <div class="sliderCheckbox round"></div>
                                        </label>
                                    </div>
                                </div>

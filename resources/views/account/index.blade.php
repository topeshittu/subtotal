            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <br>
                                <div class="table-responsive">
                                    <table class="table max-table" id="other_account_table">
                                        <thead>
                                            <tr>
                    ...
                    <div class="tab-pane" id="capital_accounts">
                        <table class="table max-table" id="capital_account_table" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>@lang( 'lang_v1.name' )</th>
                                    <th>@lang('account.account_number')</th>
                    ...
                    <div class="tab-pane" id="account_types">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table max-table" id="account_types_table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>@lang( 'lang_v1.name' )</th>
                                            <th>@lang( 'messages.action' )</th>
                                        ...
                                        @foreach($account_types as $account_type)
                                            <tr class="account_type_{{$account_type->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button title="@lang( 'messages.edit' )" type="button" class="btn-modal btn-xs" 
                                                    data-href="{{action('AccountTypeController@edit', $account_type->id)}}"
                                                    data-container="#account_type_modal">
                                                    <img src="{{ asset('img/icons/edit.svg') }}" alt="">
                                                </button>

                                                    <button title="@lang('messages.delete')" type="button" class="delete_account_type" >

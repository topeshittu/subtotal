								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive" style="min-height: .01%; overflow-x: auto;">
											<table class="table table-condensed table-bordered text-center table-striped max-table">
												<thead>
													<tr>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="text-center">
				      			<div class="btn-group">
									<button id="opening_stock_button" @if($product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="btn bg-navy submit_form">@lang('lang_v1.save_n_add_opening_stock')</button>
									<button type="submit" value="save_n_add_another" class="btn btn-warning submit_form">@lang('lang_v1.save_n_add_another')</button>
				          			<button type="submit" value="submit" class="btn bg-navy submit_form">@lang('messages.save')</button>
				          		</div>
				          	</div>
						</div>
					</div>

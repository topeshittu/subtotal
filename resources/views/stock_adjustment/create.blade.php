    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            <div class="title">
                ...
                <p>@lang('stock_adjustment.stock_adjustments')</p>
            </div>
						...
						<div class="row">
							<div class="col-sm-10 col-sm-offset-1">
								...
								id="stock_adjustment_product_table">
									...
									<tfoot>
										<tr class="text-center show_price_with_permission"><td colspan="3"></td><td><div class="pull-right"><b>@lang('stock_adjustment.total_amount'):</b> <span id="total_adjustment">0.00</span></div></td></tr>
									</tfoot>
								</table>
								</div>
							</div>

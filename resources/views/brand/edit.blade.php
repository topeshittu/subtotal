  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          <p>{{ __('repair::lang.use_for_repair') }} @show_tooltip(__('repair::lang.use_for_repair_help_text'))</p>
          <div class="toggle-wrapper d-flex gap-2 mt-4">
              <label class="switch" for="use_for_repair">
                  {!! Form::checkbox('use_for_repair', 1, $brand->use_for_repair, ['id' => 'use_for_repair']) !!}

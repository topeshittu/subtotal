  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
     <div class="form-group">
      ...
      <div class="form-group">
        <p>@lang('lang_v1.add_as_sub_cat')</p>
        <div class="toggle-wrapper d-flex gap-2 mt-4">
            <label class="switch" for="add_as_sub_cat">
                {!! Form::checkbox('add_as_sub_cat', 1, !empty($expense_category->parent_id), ['id' => 'add_as_sub_cat', 'class' => 'toggler', 'data-toggle_id' => 'parent_cat_div']) !!}

      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="well">
            ...
            <strong>@lang('sale.customer_name'): </strong> {{ $contact_details->name }}
            @else
            <strong>@lang('business.business_name'): </strong> {{ $contact_details->supplier_business_name }}
            @endif
            <br>
        ...
        <div class="col-md-6">
          <div class="well">
            <strong>@lang('sale.customer_name'): </strong>{{ $contact_details->name }}1<br>
            <br><br>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select("method", $payment_types, $payment_line->method, ['class' => 'form-control select2 payment_types_dropdown', 'required', 'style' => 'min-width:100px;']); !!}
            </div>
          </div>
        </div>

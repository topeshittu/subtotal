<div class="row">
	<div class="col-sm-12">
		...
		<div class="box box-solid">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-sm-12" style="min-height: .01%; overflow-x: auto;">
						<table class="table table-condensed table-bordered text-center table-striped max-table add_opening_stock_table">
								<thead>
								<tr>

@php
    $sms_settings['url'] = 'http://login.betasms.com.ng/api/';
    $sms_settings['send_to_param_name'] = 'mobiles';
    $sms_settings['msg_param_name'] = 'message';
    $sms_settings['request_method'] = 'get';
    
    $sms_settings['param_1'] = 'username';
    $sms_settings['param_2'] = 'password';
    $sms_settings['param_3'] = 'sender';
    $sms_settings['param_4'] = 'verbose';
    $sms_settings['param_val_4'] = 'true';
...
<div class="pos-tab-content">
    <div class="row">
        <div class="hide">
            ...
            {!! Form::select('sms_settings[sms_service]', ['nexmo' => 'Nexmo', 'twilio' => 'Twilio', 'other' => __('lang_v1.other')], $sms_service , ['class' => 'form-control hide', 'id' => 'sms_service']); !!}
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('sms_settings_param_val1', ucfirst($sms_settings['param_1'])) !!}
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('sms_settings_param_val2', ucfirst($sms_settings['param_2'])) !!}
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('sms_settings_param_val3', ucfirst($sms_settings['param_3'])) !!}

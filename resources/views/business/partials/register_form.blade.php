...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('start_date', null, ['class' => 'form-control start-date-picker','placeholder' => __('business.start_date'), 'required', 'readonly']); !!}
   </div>
    </div>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
    @if(!empty($system_settings['superadmin_enable_register_tc']))
        <div class="form-group">
            <label>
                {!! Form::checkbox('accept_tc', 1, true, ['required', 'class' => 'input-icheck']); !!}

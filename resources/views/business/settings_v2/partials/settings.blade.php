       ...
       <!--  <pos-tab-container> -->
        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                <!-- tab 1 start -->
                {{-- @include('business.business-settings')
                <!-- tab 1 end --> --}}
                <!-- tab 2 start -->
                @include('business.tax-settings')
                <!-- tab 2 end -->
                <!-- tab 3 start -->
                {{-- @include('business.product-settings') --}}

                @include('business.contact-settings')
                <!-- tab 3 end -->
                <!-- tab 4 start -->
                {{-- @include('business.sales-settings') --}}
                @include('business.pos-settings')
                <!-- tab 4 end -->
                <!-- tab 5 start -->
                @include('business.purchases-settings')

                {{-- @include('business.payment-settings') --}}
                <!-- tab 5 end -->
                <!-- tab 6 start -->
                @include('business.dashboard-settings')
                <!-- tab 6 end -->
                <!-- tab 7 start -->
                @include('business.apperance-settings')
                <!-- tab 7 end -->
                <!-- tab 8 start -->
                @include('business.prefixes-settings')
                <!-- tab 8 end -->
                <!-- tab 9 start -->
                {{-- @include('business.email-settings') --}}
                <!-- tab 9 end -->
                <!-- tab 10 start -->
                @include('business.sms-settings')
                <!-- tab 10 end -->
                <!-- tab 11 start -->
                @include('business.reward-points-settings')
                <!-- tab 11 end -->
                <!-- tab 12 start -->
                @include('business.modules-settings')
                <!-- tab 12 end -->
                @include('business.custom-label-settings')
            </div>
        @endcomponent
        {{-- </div> --}}
        <!--  </pos-tab-container> -->

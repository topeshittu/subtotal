  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="form-group col-sm-12">
          <p>@lang('lang_v1.add_as_multiple_of_base_unit') @show_tooltip(__('lang_v1.multi_unit_help'))</p>
          <div class="toggle-wrapper d-flex gap-2 mt-4">
              <label class="switch" for="define_base_unit">
                  {!! Form::checkbox('define_base_unit', 1, !empty($unit->base_unit_id), ['id' => 'define_base_unit', 'class' => 'toggler', 'data-toggle_id' => 'base_unit_div']) !!}

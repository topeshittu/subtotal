		...
		<div class="small-box bg-gray">
            <div class="inner">
            	...
            	<table class="table no-margin no-border table-slim">
            		...
            		<tr><th>@lang('restaurant.order_status')</th><td><span class="label @if($order->res_line_order_status == 'cooked' ) bg-red @elseif($order->res_line_order_status == 'served') bg-green @else bg-light-blue @endif">@lang('restaurant.order_statuses.' . $order->res_line_order_status) </span></td></tr>
            ...
            @elseif($orders_for == 'waiter' && $order->res_line_order_status != 'served')

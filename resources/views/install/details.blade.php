              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="Bard POS" required>
                    </div>
                  </div>
                ...
                <h4> License Details <small class="text-danger">Make sure to provide correct information from bardpos.com license details</small></h4>
                <hr/>

                <div class="col-md-4">
                    <div class="form-group">
                        <label for="purchase_code">Purchase Code (license Code):*</label>
                        <input type="password" name="PURCHASE_CODE" required class="form-control" id="purchase_code">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@bardpos.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="Bard POS (Optional)">
                    </div>
                  </div>

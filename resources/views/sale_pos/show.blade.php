...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <span class="label @if(!empty($shipping_status_colors[$sell->shipping_status])) {{$shipping_status_colors[$sell->shipping_status]}} @else {{'bg-max-tr'}} @endif">{{$shipping_statuses[$sell->shipping_status] ?? '' }}</span><br>
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <p class="well well-sm no-shadow bg-max-tr">
  ...
  <div class="modal-footer" >
    ...
    @if($sell->type != 'sales_order')
    <a href="#" class="print-invoice btn  btn-primary" data-href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true" style="margin-left: 0px!important;"><i class="fas fa-file-alt" aria-hidden="true"></i> @lang("lang_v1.packing_slip")</a>
    @endif
    @can('print_invoice')
      <a href="#" class="print-invoice btn btn-primary" data-href="{{ route('sell.printInvoice', [$sell->id, 'invoice' => 1]) }}"><i class="fa fa-print" aria-hidden="true"></i> @lang('messages.print')</a>
    @endcan

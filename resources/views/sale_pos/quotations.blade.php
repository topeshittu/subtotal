            ...
            <div class="filter">
                <div class="new-user">
                    @can('direct_sell.access')
                        <a class="add-user-modal-btn" href="{{action('SellController@create', ['status' => 'quotation'])}}"> <i class="fa fa-plus"></i> @lang( 'messages.add' )</a>
                    @endcan
                </div>
    ...
    @endcomponent
            ...
            <div class="content">
                <div class="table-responsive">
                    <table class="table ajax_view max-table" id="sell_table">
                        <thead>
                            <tr>

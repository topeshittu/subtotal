          ...
          <div class="col-md-6">
              <div class="toggle-wrapper" style="display: flex; gap: 10px;">
                    <label class="radio-inline">
                        <input type="radio" checked name="contact_type_radio" id="inlineRadio1" value="individual">
        ...
        <div class="row">            
            ...
            <div class="col-md-6 business" style="display: none;">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('supplier_business_name', null, ['class' => 'form-control','id' => 'business_name', 'placeholder' => __('business.business_name')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'maxlength'=>'20', 'placeholder' => __('contact.mobile')]); !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div id="zatca_b2b">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('address_line_1', null, ['class' => 'form-control','id' => 'address_line_1', 'placeholder' => __('zatca::lang.street_name'), 'rows' => 3, ]); !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                      {!! Form::label('tax_number', __('zatca::lang.tax_id') . ':') !!}
                    {!! Form::text('tax_number', null, ['class' => 'form-control','id' => 'tax_number', 'placeholder' => __('zatca::lang.tax_id')]); !!}
                    </div>
                </div>
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('address_line_2', __('zatca::lang.building_number') . ':') !!}
                    {!! Form::text('address_line_2', null, ['class' => 'form-control','id' => 'address_line_2', 'placeholder' => __('zatca::lang.building_number'), 'rows' => 3,'pattern'=> '\d{4}','maxlength' => 4,'title' => __('zatca::lang.min_req', ['min' => 4])]); !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('city', __('business.city') . ':') !!}
                    {!! Form::text('city', null, ['class' => 'form-control','id' => 'city', 'placeholder' => __('business.city')]); !!}
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div id="more_div" class="hide">
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::text('tax_number', null, ['class' => 'form-control','id' => 'tax_number', 'placeholder' => __('contact.tax_no')]); !!}
                    </div>
                </div>
                @endif
                ...
                <div class="col-md-6 pay_term">
                  <div class="form-group">
                    <div class="multi-input">
                      {!! Form::label('pay_term_number', __('contact.pay_term') . ': ') !!}<br>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('address_line_1', null, ['class' => 'form-control','id' => 'address_line_1', 'placeholder' => __('lang_v1.address_line_1'), 'rows' => 3]); !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('address_line_2', __('lang_v1.address_line_2') . ':') !!}
                        {!! Form::text('address_line_2', null, ['class' => 'form-control','id' => 'address_line_2', 'placeholder' => __('lang_v1.address_line_2'), 'rows' => 3]); !!}
                    </div>
                </div>
                @endif
                <div class="col-md-6">

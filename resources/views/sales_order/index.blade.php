    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div class="filter">
               ...
               <div class="new-user">
               @can('so.create')
                   <a class="add-user-modal-btn" href="{{action([\App\Http\Controllers\SellController::class, 'create'])}}?sale_type=sales_order"><i class="fa fa-plus"></i> @lang('lang_v1.add_sales_order')</a>
                    @endcan
               </div>
...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped ajax_view max-table" id="sell_table">
                <thead>
                    <tr>

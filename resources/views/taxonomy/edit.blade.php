  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        @if(request()->get('type') == 'source')
          {!! Form::select('name', ['Facebook' => 'Facebook', 'Whatsapp' => 'Whatsapp', 'Youtube' => 'Youtube', 'Instagram' => 'Instagram', 'Google' => 'Google', 'Radio' => 'Radio', 'Referral' => 'Referral', 'Other' => 'Other'], $category->name, ['class' => 'form-control select2', 'placeholder' => 'Select Source']); !!}
        @else
      ...
      <div class="form-group">
        <p>@lang('lang_v1.add_as_sub_txonomy')</p>
        <div class="toggle-wrapper d-flex gap-2 mt-4">
            <label class="switch" for="add_as_sub_cat">
                {!! Form::checkbox('add_as_sub_cat', 1, !$is_parent, ['id' => 'add_as_sub_cat', 'class' => 'toggler', 'data-toggle_id' => 'parent_cat_div']) !!}

...
<div class="modal-body">
        ...
        <table class="table bg-gray table-bordered">
          <thead>
            <tr class="bg-green">
              ...
              @if(session('business.ep_sub_total'))
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              @endif
              <td class="text-right"><span class="display_currency" data-is_quantity="true" data-currency_symbol="false">{{ $purchase_line->quantity }}</span> @if(!empty($purchase_line->sub_unit)) {{$purchase_line->sub_unit->short_name}} @else {{$purchase_line->product->unit->short_name}} @endif
  ...
  <div class="row">
    @if(!empty($purchase->type == 'purchase'))
      @if(session('business.ep_payment_info'))
      <div class="col-sm-12 col-xs-12">
    ...
    <div class="col-md-6 col-sm-12 col-xs-12 @if($purchase->type == 'purchase_order') col-md-offset-6 @endif">
      <div class="table-responsive">
        <table class="table">
          ...
          @if(session('business.ep_net_total_amount'))
          <tr>
          ...
          @if(session('business.ep_discount'))
          <tr>
          ...
          @endif
          @if(session('business.ep_purchase_tax'))
          <tr>
          ...
          @if( !empty( $purchase->shipping_charges ) )
            @if(session('business.ep_additional_shipping_charges'))
            <tr>
          ...
          @endif
          @if(session('business.ep_purchase_total'))
          <tr>
  ...
  <div class="row">
    @if(session('business.ep_shipping_details'))
    <div class="col-sm-6">

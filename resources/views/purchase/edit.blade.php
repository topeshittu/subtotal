          ...
          <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
            ...
            <div class="accordionItem">
                ...
                <div class="accordionContent">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group add-new-product-btn">
                        <button tabindex="-1" type="button" class="btn btn-modal"data-href="{{action('ProductController@quickAdd')}}" 
                              data-container=".quick_add_product_modal">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <g clip-path="url(#clip0_1557_19505)">
                                  <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" fill="#2563EB"/>
                                  </g>
                                  <defs>
                                  <clipPath id="clip0_1557_19505">
            ...
            <div class="accordionItem">
                ...
                <div class="accordionContent">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12" id="additional_expenses_div">

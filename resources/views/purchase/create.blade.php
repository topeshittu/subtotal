		...
		<div class="content">
			...
			<div class="accordionItem">
				...
				<div class="accordionTitle is-open">
					<h2 class="">@lang('purchase.add_purchase')</h2>
				...
				<div class="accordionContent">
					<div class="row">
						...
						<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-4 @endif @if(!session('business.ep_reference')) hide @endif">
							<div class="form-group">
						...
						<div class="col-md-4 @if(!session('business.ep_pay_term')) hide @endif">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="table-responsive" style="min-height: .01%; overflow-x: auto;">
								<table class="table table-condensed table-bordered text-center table-striped general-table" id="purchase_entry_table">
									<thead>
										<tr>
											<th>#</th>
							...
							<div class="pull-right col-md-5">
								<table class="pull-right col-md-12 bg-gray">
									<tr>
			...
			<div class="accordionItem">
				<!-- Accordion Title -->
				<div class="accordionTitle is-open">
					<h2 class="">@lang('purchase.discount')</h2>
			...
			<div class="accordionItem">
				<!-- Accordion Title -->
				<div class="accordionTitle is-open">
					<h2 class="">@lang('purchase.shipping_details')</h2>
				...
				<div class="accordionContent">
					...
					<div class="row ">
						<div class="col-md-12 text-center">
							<button type="button" class="primary-button" id="toggle_additional_expense"> <i class="fas fa-plus"></i> @lang('lang_v1.add_additional_expenses') <i class="fas fa-chevron-down"></i></button>
						</div>
						<div class="col-md-12" id="additional_expenses_div" style="display: none;">
			...
			<div class="accordionItem">
				<!-- Accordion Title -->
				<div class="accordionTitle is-open">
					<h2 class="">@lang('purchase.add_payment')</h2>
				...
				<div class="accordionContent payment_row">
					<div class="row">
						<div class="col-md-12">
					...
					<div class="row">
						<div class="col-sm-12 text-center">
							<button type="button" id="submit_purchase_form" class="btn btn-primary btn-big">@lang('messages.save')</button>
						</div>
					</div>
				</div>
			</div>

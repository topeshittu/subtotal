    ...
    <div class="table-responsive">
      <table class="table bg-gray table-bordered">
        <tr class="bg-green">
          ...
          <th>@lang('sale.qty')</th>
          @if(session('business.es_unit_price'))
            <th>@lang('sale.unit_price')</th>
          @endif
          @if(session('business.es_sub_total'))
...
<div class="row">
  ...
  <div class="col-xs-6">
    <div class="table-responsive">
      <table class="table">
        @if(session('business.es_net_total_amount'))
        <tr>
        ...
        @if( !empty( $sell_transfer->shipping_charges ) )
          @if(session('business.es_additional_shipping_charges'))
          <tr>
          ...
          @endif
        @endif
        @if(session('business.es_purchase_total'))
        <tr>
...
<div class="row">
  <div class="col-sm-6">
   ...
   @if(session('business.es_approved_by'))
    <div class="col-sm-6">
      <strong>@lang('lang_v1.approved_by'):</strong><br>
      <p class="well well-sm no-shadow bg-gray">
          --
      </p>
    </div>

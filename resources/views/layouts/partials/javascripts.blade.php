...
@yield('javascript')
<script>
        window.mediaUploadConfig = {
            allowedExtensions: @json(config('constants.media_upload.allowed_extensions')),
            allowedMimeTypes: @json(config('constants.media_upload.allowed_mime_types')),
            document_size_limit: @json(config('constants.document_size_limit'))
        };
    </script>

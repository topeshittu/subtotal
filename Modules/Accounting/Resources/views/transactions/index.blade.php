...
<script type="text/javascript">
    $(document).ready( function(){
        sell_table = $('#sell_table').DataTable({
            ...
            aaSorting: [[1, 'desc']],
            "ajax": {
                "url": '{{ route("transactions") }}?type=sell&datatable=sell',
                "data": function ( d ) {
        ...
        sell_payment_table = $('#sell_payment_table').DataTable({
                            ...
                            "ajax": {
                                ...
                                "url": '{{ route("transactions") }}?transaction_type=sell&datatable=payment',
        ...
        purchase_payment_table = $('#purchase_payment_table').DataTable({
                            ...
                            "ajax": {
                                ...
                                "url": '{{ route("transactions") }}?transaction_type=purchase&datatable=payment',
                                "data": function ( d ) {
                                    // d.account_id = $('#account_id').val();
                                    // var start_date = '';
                                    // var endDate = '';
        ...
        purchase_table = $('#purchase_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": '{{ route("transactions") }}?datatable=purchase',

...
Route::middleware($middleware)->prefix('accounting')->group(function () {
    ...
    Route::get('accounting/transactions', [\Modules\Accounting\Http\Controllers\TransactionController::class, 'index'])->name('transactions');

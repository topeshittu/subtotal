            ...
            if ($lead_view == 'list_view') {
                return Datatables::of($leads)
                    ...
                    ->addColumn('upcoming_follow_up', function ($row) {
                        ...
                        $html .= '<a href="#" data-href="'.action([\Modules\Crm\Http\Controllers\ScheduleController::class, 'create'], ['schedule_for' => 'lead', 'contact_id' => $row->id]).'" class="btn-modal btn btn-xs btn-success" data-container=".schedule">

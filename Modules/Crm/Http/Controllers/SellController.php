...
class SellController extends Controller
{
    ...
    public function getSellList(Request $request)
    {
                    ...
                    ->addColumn(
                        ...
                        function ($row) {
                            $html = '<div class="btn-group">
                                ...
                                <li><a href="#" class="print-invoice" data-href="' . route('sell.printInvoice', [$row->id]) . '?invoice=1">                                <i class="fas fa-print" aria-hidden="true"></i> '.__('messages.print').'</a></li>
        ...
        return view('crm::sell.index') ->with(compact('contact'));
    }
}

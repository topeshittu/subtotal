...
$middleware_contact = ['web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone',  'CheckContactLogin'];
if (app(App\Services\AppSettingsService::class)->force_email_verify())  {
    $middleware_contact[] = 'verified';
}

Route::middleware($middleware_contact)->prefix('contact')->group(function () {
...
Route::middleware($middleware)->prefix('crm')->group(function () {
    ...
    Route::get('follow-up-log',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'index'])->name('follow-up-log.index');
    Route::get('follow-up-log/create',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'create'])->name('follow-up-log.create');
    Route::post('follow-up-log',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'store'])->name('follow-up-log.store');
    Route::get('follow-up-log/edit/{id}',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'edit'])->name('follow-up-log.edit');
    Route::put('follow-up-log/{id}',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'update'])->name('follow-up-log.update');
    Route::get('follow-up-log/{id}',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'show'])->name('follow-up-log.show');
    Route::delete('follow-up-log/destroy/{id}',[Modules\Crm\Http\Controllers\ScheduleLogController::class,'destroy'])->name('follow-up-log.destroy');

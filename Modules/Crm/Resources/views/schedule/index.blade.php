...
<div class="main-container">
    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div class="filter">
               <div class="new-user">
	    			<button id="followupButton" type="button" class="primary-button btn-add-schedule">
		                <i class="fa fa-plus"></i> @lang('messages.add')
				    </button>	
	            </div>

	            <div class="new-user">
	    			<button id="recurringButton" type="button" class="primary-button" data-toggle="modal" data-target="#advance_followup_modal">
		                <i class="fa fa-plus"></i> @lang('crm::lang.add_advance_follow_up')
		            </button>	
	            </div>
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="form-group">
	                    ...
	                    {!! Form::select('contact_id_filter', $contacts, null, ['class' => 'form-control select2', 'id' => 'contact_id_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
	                </div>    
	            </div>
	            @if(auth()->user()->can('crm.access_all_schedule'))
		            <div class="col-md-4">
		                <div class="form-group">
		                    ...
		                    {!! Form::select('assgined_to_filter', $assigned_to, $default_user, ['class' => 'form-control select2', 'id' => 'assgined_to_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
		                </div>    
		            </div>
		        @endif
	            <div class="col-md-4">
	                <div class="form-group">
	                    ...
	                    {!! Form::select('status_filter', $statuses, $default_status, ['class' => 'form-control select2', 'id' => 'status_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
	                </div>    
	            </div>
	            <div class="clearfix">
	            </div>
	            <div class="col-md-3">
	                <div class="form-group">
	                    ...
	                    {!! Form::select('schedule_type_filter', $follow_up_types, null, ['class' => 'form-control select2', 'id' => 'schedule_type_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
	                </div>    
	            </div>
	            <div class="col-md-3">
	            	<div class="form-group">
	            ...
	            <div class="col-md-3">
	                <div class="form-group">
	                    ...
	                    {!! Form::select('follow_up_by_filter', ['payment_status' => __('sale.payment_status'), 'orders' => __('restaurant.orders')], null, ['class' => 'form-control select2', 'id' => 'follow_up_by_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
	                </div>    
	            </div>
	            <div class="col-md-3">
	                <div class="form-group">
	                    {!! Form::label('followup_category_id_filter', __('crm::lang.followup_category') . ':') !!}
	                    {!! Form::select('followup_category_id_filter', $followup_category, $default_followup_category_id, ['class' => 'form-control select2', 'id' => 'followup_category_id_filter', 'placeholder' => __('messages.all'), 'style' => 'width: 100%']); !!}
	                </div>    
	            </div>
	        </div>
	    @endcomponent
						                ...
						                <div class="tab-content">
			                    			<div class="tab-pane active" id="all_followup_tab">
			                    				<div class="table-responsive">
									            	<table class="table max-table display nowrap" id="follow_up_table" style="width: 100%">
												        <thead>
												            <tr>
			                    			...
			                    			<div class="tab-pane" id="recur_followup_tab">
			                    				<div class="table-responsive">
									            	<table class="table max-table display nowrap" id="recursive_follow_up_table"  style="width: 100% !important">
												        <thead>
												            <tr>
												            	<th>@lang('messages.action')</th>
												                <th>@lang('sale.status')</th>

                        ...
                        <div class="form-group">
                            ...
                            <div class="toggle-wrapper d-flex gap-2 mt-4">
                                <label class="switch" for="allow_notification">
                                    {!! Form::checkbox('allow_notification', 1, $schedule->allow_notification, ['id' => 'allow_notification']) !!}
                            ...
                            <div class="form-group">
                                <div class="toggle-wrapper d-flex gap-2 mt-4">
                                    <label class="switch" for="notify_via_sms">
                                        {!! Form::checkbox('notify_via[sms]', 1, $schedule->notify_via['sms'], ['id' => 'notify_via_sms']) !!}
                                        <div class="sliderCheckbox round"></div>
                                    </label>
                                    <span>{{ __('crm::lang.sms') }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="toggle-wrapper d-flex gap-2 mt-4">
                                    <label class="switch" for="notify_via_mail">
                                        {!! Form::checkbox('notify_via[mail]', 1, $schedule->notify_via['mail'], ['id' => 'notify_via_mail']) !!}
                                        <div class="sliderCheckbox round"></div>
                                    </label>
                                    <span>{{ __('business.email') }}</span>
                                </div>
                            </div>
                        </div>

        ...
        <div class="box box-solid hide hidden_box">
        	<div class="box-body">
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-6">
						<div class="form-group">
							<p>@lang('crm::lang.send_notification') @show_tooltip(__('crm::lang.send_schedule_notificatoion'))</p>
							<div class="toggle-wrapper d-flex gap-2 mt-4">
								<label class="switch" for="allow_notification">
									{!! Form::checkbox('allow_notification', 1, false, ['id' => 'allow_notification']) !!}
		        ...
		        <div class="row">
		            <div class="allow_notification_elements hide">
							...
							<div class="col-md-12">
								<div class="form-group">
						<p>{{ __('crm::lang.notify_via') }}:* </p>
								</div>
						</div>
		                <div class="col-sm-3">
							<div class="form-group">
								
								<span>@lang('crm::lang.sms')</span>
								<div class="toggle-wrapper d-flex gap-2 mt-4">
									<label class="switch" for="notify_via_sms">
										{!! Form::checkbox('notify_via[sms]', 1, false, ['id' => 'notify_via_sms']) !!}
										<div class="sliderCheckbox round"></div>
									</label>
								</div>
							</div>
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<div class="toggle-wrapper d-flex gap-2 mt-4">
									<label class="switch" for="notify_via_mail">
										{!! Form::checkbox('notify_via[mail]', 1, true, ['id' => 'notify_via_mail']) !!}
										<div class="sliderCheckbox round"></div>		
									</label>
...
<script type="text/javascript">
	$(document).ready( function(){
		...
		$(document).on('change', '#allow_notification', function() {
			$('.allow_notification_elements').toggleClass('hide', ! this.checked);
		});

	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						<p>{{ __('lang_v1.status_for_user') }} @show_tooltip(__('lang_v1.tooltip_enable_user_active'))</p>
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="toggle-wrapper d-flex gap-2 mt-4">
							<label class="switch" for="allow_login">
								{!! Form::checkbox('allow_login', 1, false, ['id' => 'allow_login', 'class' => 'allow_login',   'data-loginDiv' => 'crm_login_div']) !!}
								<div class="sliderCheckbox round"></div>
							</label>
						</div>
					</div>

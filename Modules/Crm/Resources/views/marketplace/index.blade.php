    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
			...
			<div class="filter">
					...
					<div class="new-user"><a href="{{action([\Modules\Crm\Http\Controllers\CrmMarketplaceController::class, 'importLeads'])}}" class="btn btn-primary btn-block">@lang('crm::lang.import_leads')</a></div>

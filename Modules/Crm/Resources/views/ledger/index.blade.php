		...
		<div class="box-body">
		    <div class="col-md-12">
		        ...
		        <div class="col-md-9 text-right">
		            <button data-href="{{action([\Modules\Crm\Http\Controllers\LedgerController::class, 'getLedger'])}}?action=pdf" class="btn btn-default btn-xs" id="create_ledger_pdf">{{__('crm::lang.download_pdf')}}<i class="fas fa-file-pdf"></i></button>
		        </div>
		    </div>

...
class Schedule extends Model
{
    ...
    {
        return $this->belongsToMany(\App\Models\User::class, 'crm_schedule_users', 'schedule_id', 'user_id');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\Transaction::class, 'crm_followup_invoices', 'follow_up_id', 'transaction_id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\Category::class, 'followup_category_id');
    }
}

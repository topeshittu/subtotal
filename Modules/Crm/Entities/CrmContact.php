...
class CrmContact extends Contact
{
    ...
    {
        return $this->belongsToMany(\App\Models\User::class, 'crm_lead_users', 'contact_id', 'user_id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\Category::class, 'crm_source');
    }
    ...
    {
        return $this->belongsTo(\App\Models\Category::class, 'crm_life_stage');
    }

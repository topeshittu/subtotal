...
function crm($ul, $pt, $lc, $em, $un, $type = 1, $pid = null)
{
    $ch = curl_init();
    $request_url = ($type == 1) ? base64_decode(config('crm.lic1')) : base64_decode(config('crm.lic2'));
   
    $pid = is_null($pid) ? config('crm.pid') : $pid;

...
$middleware = ['web', 'SetSessionData', 'auth', 'language', 'timezone', 'superadmin','force.2fa'];

if (app(App\Services\AppSettingsService::class)->force_email_verify())  {
    $middleware[] = 'verified';
}

Route::middleware($middleware)->prefix('superadmin')->group(function () {
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone')->group(function () {

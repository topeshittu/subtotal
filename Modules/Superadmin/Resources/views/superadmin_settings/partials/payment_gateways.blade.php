    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <p>@lang('superadmin::lang.enable_offline_payment')</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="enable_offline_payment">
                        {!! Form::checkbox('enable_offline_payment', 1, !empty($settings["enable_offline_payment"]), ['id' => 'enable_offline_payment']) !!}

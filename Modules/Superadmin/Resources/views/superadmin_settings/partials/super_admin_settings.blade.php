<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <p>{{ __('superadmin::lang.enable_business_based_username') }}</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="enable_business_based_username">
                        {!! Form::checkbox('enable_business_based_username', 1, (int)$settings["enable_business_based_username"], ['id' => 'enable_business_based_username']) !!}

<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <p>@lang('superadmin::lang.allow_email_settings_to_businesses') @show_tooltip(__('superadmin::lang.allow_email_settings_tooltip'))</p>
                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                        <label class="switch" for="allow_email_settings_to_businesses">
                            {!! Form::checkbox('allow_email_settings_to_businesses', 1, !empty($settings["allow_email_settings_to_businesses"]), ['id' => 'allow_email_settings_to_businesses']) !!}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <p>@lang('superadmin::lang.enable_new_business_registration_notification') @show_tooltip(__('superadmin::lang.new_business_notification_tooltip'))</p>
                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                        <label class="switch" for="enable_new_business_registration_notification">
                            {!! Form::checkbox('enable_new_business_registration_notification', 1, !empty($settings["enable_new_business_registration_notification"]), ['id' => 'enable_new_business_registration_notification']) !!}
                            <div class="sliderCheckbox round"></div>
                        </label>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <p>@lang('superadmin::lang.enable_new_subscription_notification') @show_tooltip(__('superadmin::lang.new_subscription_tooltip'))</p>
                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                        <label class="switch" for="enable_new_subscription_notification">
                            {!! Form::checkbox('enable_new_subscription_notification', 1, !empty($settings["enable_new_subscription_notification"]), ['id' => 'enable_new_subscription_notification']) !!}
                            <div class="sliderCheckbox round"></div>
                        </label>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <hr>
                <div class="form-group">
                    <p>@lang('superadmin::lang.enable_welcome_email') @show_tooltip(__('superadmin::lang.new_business_welcome_notification_tooltip'))</p>
                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                        <label class="switch" for="enable_welcome_email">
                            {!! Form::checkbox('enable_welcome_email', 1, isset($settings["enable_welcome_email"]) ? (int)$settings["enable_welcome_email"] : false, ['id' => 'enable_welcome_email']) !!}
                            <div class="sliderCheckbox round"></div>
                        </label>
                    </div>
                </div>

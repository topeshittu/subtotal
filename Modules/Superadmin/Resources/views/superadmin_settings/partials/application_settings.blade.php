<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <p>@lang('superadmin::lang.allow_registration')</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="ALLOW_REGISTRATION">
                        {!! Form::checkbox('ALLOW_REGISTRATION', 1, !empty($default_values["ALLOW_REGISTRATION"]), ['id' => 'ALLOW_REGISTRATION']) !!}
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <p>@lang('superadmin::lang.enable_register_tc')</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="superadmin_enable_register_tc">
                        {!! Form::checkbox('superadmin_enable_register_tc', 1, !empty($settings["superadmin_enable_register_tc"]), ['id' => 'superadmin_enable_register_tc']) !!}
                        <div class="sliderCheckbox round"></div>
                    </label>
                </div>
            </div>

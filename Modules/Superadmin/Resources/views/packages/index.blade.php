...
<div class="main-container no-print">
	...
	<div class="overview-filter">
		...
		<div class="title">
			<h1> @lang('superadmin::lang.packages')
			</h1>
			<p>@lang('superadmin::lang.all_packages')</p>
		</div>
		<div class="filter">
                <div class="new-user">
					<a href="{{action([\Modules\Superadmin\Http\Controllers\PackagesController::class, 'create'])}}" class="btn btn-block btn-primary">
		...
		<section class="content">
			...
			<div class="box box-solid">
				<div class="box-body">
					...
					<div class="col-md-4">
						<div class="box box-warning hvr-grow-shadow">
							<div class="box-header with-border text-center">
								...
								<div class="row">
									...
									<a href="#!" class="btn btn-box-tool">
										<i class="fas fa-lock fa-lg text-warning" data-toggle="tooltip" title="@lang('superadmin::lang.private_superadmin_only')"></i>
									</a>
									@endif

									@if($package->is_one_time)
									<a href="#!" class="btn btn-box-tool">
										<i class="fas fa-dot-circle fa-lg text-info" data-toggle="tooltip" title="@lang('superadmin::lang.one_time_only_subscription')"></i>
									</a>
									@endif

...
namespace Modules\Desktopapp\Http\Controllers\Api\Crm;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Routing\Controller;
use Modules\Desktopapp\Http\Controllers\Api\ApiController;
...
{   
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/desktopapp/api/crm/follow-ups?page=1",
                "last": "http://local.pos.com/desktopapp/api/crm/follow-ups?page=21",
                "prev": null,
                "next": "http://local.pos.com/desktopapp/api/crm/follow-ups?page=2"
            },
            "meta": {
                "current_page": 1,
                "from": 1,
                "last_page": 21,
                "path": "http://local.pos.com/desktopapp/api/crm/follow-ups",
                "per_page": "2",
                "to": 2,
                "total": 42
            }
    ...
    */
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/desktopapp/api/crm/leads?page=1",
                "last": "http://local.pos.com/desktopapp/api/crm/leads?page=1",
                "prev": null,
                "next": null
            },
            "meta": {
                ...
                "from": 1,
                "last_page": 1,
                "path": "http://local.pos.com/desktopapp/api/crm/leads",
                "per_page": "10",
                "to": 3,
                "total": 3
            }

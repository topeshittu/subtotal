...
namespace Modules\Desktopapp\Http\Controllers\Api\FieldForce;
...
class FieldForceController extends ApiController
{
     ...
     *  @response {
        ...
        "links": {
            "first": "http://local.pos.com/desktopapp/api/field-force?page=1",
            "last": "http://local.pos.com/desktopapp/api/field-force?page=1",
            "prev": null,
            "next": null
        },
        "meta": {
            ...
            "from": 1,
            "last_page": 1,
            "path": "http://local.pos.com/desktopapp/api/field-force",
            "per_page": 15,
            "to": 2,
            "total": 2
        }

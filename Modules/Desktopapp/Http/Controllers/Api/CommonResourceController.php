...
use Modules\Desktopapp\Transformers\BusinessResource;
...
class CommonResourceController extends ApiController
{
    ...
    public function getPaymentAccounts()
    {
        ...
        //Accounts
        $accounts = Account::select('id', 'name', 'account_number')->where('business_id', $business_id)->where('is_closed', 0)
                        ->get();
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/desktopapp/api/product-stock-report?page=1",
            "last": "http://local.pos.com/desktopapp/api/product-stock-report?page=22",
            "prev": null,
            "next": "http://local.pos.com/desktopapp/api/product-stock-report?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "last_page": 22,
            "path": "http://local.pos.com/desktopapp/api/product-stock-report",
            "per_page": 3,
            "to": 3,
            "total": 66
        }

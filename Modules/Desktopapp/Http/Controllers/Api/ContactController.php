...
class ContactController extends ApiController
{
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/desktopapp/api/contactapi?page=1",
                "last": "http://local.pos.com/desktopapp/api/contactapi?page=1",
                "prev": null,
                "next": null
            },
            "meta": {
                ...
                "from": 1,
                "last_page": 1,
                "path": "http://local.pos.com/desktopapp/api/contactapi",
                "per_page": "10",
                "to": 4,
                "total": 4
            }
    ...
    */
    public function index()
    {
        ...
        if ($per_page != -1) {
            $contacts = $query->paginate($per_page, $this->selectedFields());
            $contacts->appends(request()->query());
            
        } else{
            $contacts = $query->get($this->selectedFields());
        }
    ...
    */
    ...
    {
        return ['id', 'business_id', 'type', 'supplier_business_name', 'name', 'prefix', 'first_name', 'middle_name', 'last_name', 'email', 'contact_id', 'contact_status', 'tax_number', 'city', 'state', 'country', 'address_line_1', 'address_line_2', 'zip_code', 'dob', 'mobile', 'landline', 'alternate_number', 'pay_term_number', 'pay_term_type', 'credit_limit', 'created_by', 'converted_by', 'converted_on', 'balance', 'is_default', 'shipping_address', 'customer_group_id', 'deleted_at', 'created_at', 'updated_at'];
    }
}

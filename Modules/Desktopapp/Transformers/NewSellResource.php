...
class NewSellResource extends JsonResource
{
     ...
     * @return array
     */
    public static  function CustomCollectionForPropayAndSales($resource, $propay)
    {
        self::$propay = $propay->toArray();
    ...
    public function toArray($request)
    {
        ...
        $array['propay'] = self::$propay ? self::$propay : [];

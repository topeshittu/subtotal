    ...
    <div class="card-wrapper">
     <!-- Filter through table -->
        <div class="overview-filter">
            <div class="title">
                <h1>@lang('essentials::lang.attendance')</h1>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if(!auth()->user()->can('essentials.crud_all_attendance')) active @endif" id="attendance_tab">
                        <div class="row">
                            ...
                            @can('essentials.crud_all_attendance')
                            <div class="col-md-6 spacer new-user">
                                <button type="button" class="btn btn-primary btn-block btn-modal pull-right" data-href="{{action([\Modules\Essentials\Http\Controllers\AttendanceController::class, 'create'])}}" data-container="#attendance_modal">

  	...
  	<div class="modal-content">
	    ...
	    <div class="modal-body">
	    	<div class="form-group">
			  ...
			  <div class="form-group">
				<p>@lang('essentials::lang.allow_auto_clockout') @show_tooltip(__('essentials::lang.allow_auto_clockout_tooltip'))</p>
				<div class="toggle-wrapper d-flex gap-2 mt-4">
					<label class="switch" for="is_allowed_auto_clockout">

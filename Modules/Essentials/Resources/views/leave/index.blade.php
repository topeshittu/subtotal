    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div style="display: flex; gap: 20px;">
                <div class="new-user">
                    <button type="button" class="add-user-modal-btn btn-modal btn-primary" data-href="{{action('\Modules\Essentials\Http\Controllers\EssentialsLeaveController@create')}}" data-container="#add_leave_modal">
        ...
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-solid', 'title' => __( 'essentials::lang.all_leaves' )])
                <div class="table-responsive">
                    <table class="table max-table" id="leave_table">
                        <thead>
                            <tr>

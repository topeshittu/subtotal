    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <p>@lang('essentials::lang.is_location_required')</p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="is_location_required">
                        {!! Form::checkbox('is_location_required', 1, !empty($settings['is_location_required']) ? 1 : 0, ['id' => 'is_location_required']) !!}

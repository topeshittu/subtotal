...
class RecipeController extends Controller
{
 ...
 return Datatables::of($recipes)
                ->addColumn('action', '<button data-href="{{action(\'\Modules\Manufacturing\Http\Controllers\RecipeController@show\', [$id])}}" class="btn btn-xs btn-info btn-modal" data-container=".view_modal" data-toggle="tooltip" data-placement="top" title=@lang("messages.view")><img src="' . asset('img/icons/eye.svg') . '" alt=""> </button> @can("manufacturing.edit_recipe") <a href="{{action(\'\Modules\Manufacturing\Http\Controllers\RecipeController@addIngredients\')}}?variation_id={{$variation_id}}" class="btn btn-xs" data-toggle="tooltip" data-placement="top" title=@lang("messages.edit")><img src="' . asset('img/icons/edit.svg') . '" alt=""></a>
                    <button data-href="{{action(\'\Modules\Manufacturing\Http\Controllers\RecipeController@destroy\',[$id])}}" class="btn btn-xs btn-danger delete_recipe" data-toggle="tooltip" data-placement="top" title=@lang("messages.delete")><img src="' . asset('img/icons/delete.svg') . '" alt=""></button> @endcan')

	...
	@component('components.widget', ['class' => 'box-solid', 'title' => __('manufacturing::lang.ingredients')])
		...
		<div class="row">
			<div class="col-sm-3 col-sm-offset-9">
				<div class="form-group">
					<p>@lang('manufacturing::lang.finalize') @show_tooltip(__('manufacturing::lang.finalize_tooltip'))</p>
					<div class="toggle-wrapper d-flex gap-2 mt-4">
						<label class="switch" for="finalize">
							{!! Form::checkbox('finalize', 1, false, ['id' => 'finalize']) !!}
